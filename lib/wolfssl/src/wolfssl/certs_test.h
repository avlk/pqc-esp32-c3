...
static const unsigned char bench_sphincs_fast_sha2_level1_key[] =
{
        0x30, 0x71, 
        0x02, 0x01, 0x00,
        0x30, 0x08, 0x06, 0x06, 0x2B, 0xCE, 0x0F, 0x06, 0x07, 0x0D, 
        0x04, 0x62, 
        0x04, 0x60,
        // Actual private key
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/prompt.json
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/expectedResults.json
        // tcId: 21
        0xE2, 0xBD, 0xAA, 0x37, 0xC8, 0xCF, 0xFE, 0x5E, 0x8D, 0x56, 
        0x76, 0xC2, 0x32, 0x67, 0x89, 0x0C, 0x31, 0x44, 0x17, 0x58, 
        0xF5, 0x73, 0x28, 0x58, 0x81, 0xCD, 0xC8, 0x2A, 0xB9, 0x11, 
        0xDD, 0x84, 0x72, 0xDC, 0x8D, 0x26, 0xDF, 0x6E, 0xF7, 0x08, 
        0xF4, 0xC4, 0x1A, 0xF9, 0xFD, 0x04, 0xB6, 0x5A, 0x89, 0x27, 
        0x92, 0x72, 0x29, 0x89, 0x1D, 0x47, 0xA6, 0x0D, 0x67, 0xEC, 
        0xEF, 0x3D, 0x2C, 0x17,
         // Public key
        0x72, 0xDC, 0x8D, 0x26, 0xDF, 0x6E, 0xF7, 0x08, 0xF4, 0xC4, 
        0x1A, 0xF9, 0xFD, 0x04, 0xB6, 0x5A, 0x89, 0x27, 0x92, 0x72, 
        0x29, 0x89, 0x1D, 0x47, 0xA6, 0x0D, 0x67, 0xEC, 0xEF, 0x3D, 
        0x2C, 0x17
};
static const int sizeof_bench_sphincs_fast_sha2_level1_key = sizeof(bench_sphincs_fast_sha2_level1_key);
...
static const unsigned char bench_sphincs_fast_sha2_level3_key[] =
{
        0x30, 0x81, 
        0xA3, 0x02, 0x01, 0x00, 
        0x30, 0x08, 0x06, 0x06, 0x2B, 0xCE, 0x0F, 0x06, 0x08, 0x0A, 
        0x04, 0x81, 
        0x93, 0x04, 
        0x81, 0x90, 
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/prompt.json
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/expectedResults.json
        // tcId: 61
        0x94, 0x2D, 0xD5, 0x88, 0xB0, 0xE0, 0x63, 0x60, 0x60, 0xB1, 
        0x02, 0x3B, 0xAF, 0x1D, 0xF3, 0x60, 0x02, 0xB9, 0xD3, 0xC7, 
        0x25, 0x69, 0x04, 0xF9, 0x48, 0x59, 0x6F, 0x0F, 0x2F, 0x17, 
        0x50, 0x55, 0x85, 0xF0, 0x22, 0x42, 0x34, 0x33, 0xB3, 0xA3, 
        0xEF, 0x50, 0x97, 0x7B, 0x98, 0xB0, 0x1E, 0x8E, 0x3E, 0x1D, 
        0x7D, 0xCF, 0x88, 0x0C, 0x2E, 0xA3, 0xC8, 0x87, 0x21, 0x22, 
        0xA9, 0x96, 0xD5, 0xD6, 0x23, 0x3B, 0xDF, 0xBD, 0x57, 0xFA, 
        0x64, 0x1F, 0xAD, 0x3C, 0x81, 0xBB, 0xE6, 0x77, 0x8B, 0x1F, 
        0x78, 0x81, 0x95, 0x13, 0x1B, 0x3F, 0xCA, 0x91, 0x85, 0x4F, 
        0xF3, 0xB0, 0x75, 0xBF, 0x00, 0x09,
        // Public key
        0x3E, 0x1D, 0x7D, 0xCF, 0x88, 0x0C, 0x2E, 0xA3, 0xC8, 0x87, 
        0x21, 0x22, 0xA9, 0x96, 0xD5, 0xD6, 0x23, 0x3B, 0xDF, 0xBD, 
        0x57, 0xFA, 0x64, 0x1F, 0xAD, 0x3C, 0x81, 0xBB, 0xE6, 0x77, 
        0x8B, 0x1F, 0x78, 0x81, 0x95, 0x13, 0x1B, 0x3F, 0xCA, 0x91, 
        0x85, 0x4F, 0xF3, 0xB0, 0x75, 0xBF, 0x00, 0x09
};
static const int sizeof_bench_sphincs_fast_sha2_level3_key = sizeof(bench_sphincs_fast_sha2_level3_key);
...
static const unsigned char bench_sphincs_fast_sha2_level5_key[] =
{
        0x30, 0x81, 
        0xD3, 0x02, 0x01, 0x00, 
        0x30, 0x08, 0x06, 0x06, 0x2B, 0xCE, 0x0F, 0x06, 0x09, 0x0A, 
        0x04, 0x81, 
        0xC3, 0x04,
        0x81, 0xC0, 
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/prompt.json
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/expectedResults.json
        // tcId: 101
        ,
        // Public key
        0xBD, 0xCA, 0xD4, 0xD6, 0x82, 0x1D, 0x32, 0x16, 0x8C, 0x6D, 
        0x81, 0x05, 0xE6, 0xB2, 0x26, 0x39, 0x9F, 0x86, 0x1E, 0x0D, 
        0x11, 0x10, 0xA5, 0x3E, 0xB4, 0x7A, 0xA3, 0xE1, 0x18, 0xE2, 
        0x59, 0x34, 0x09, 0xA0, 0x49, 0xCE, 0x3B, 0x61, 0xC4, 0xA6, 
        0xFD, 0x6C, 0xA1, 0x61, 0x3A, 0x4B, 0x47, 0x28, 0x15, 0x85, 
        0xE9, 0x2D, 0xE8, 0x22, 0xBF, 0x79, 0x84, 0x29, 0xB2, 0xE9, 
        0x25, 0x7A, 0x2E, 0x60
};
static const int sizeof_bench_sphincs_fast_sha2_level5_key = sizeof(bench_sphincs_fast_sha2_level5_key);
...
static const unsigned char bench_sphincs_small_sha2_level1_key[] =
{
        0x30, 0x71, 
        0x02, 0x01, 0x00, 
        0x30, 0x08, 0x06, 0x06, 0x2B, 0xCE, 0x0F, 0x06, 0x07, 0x10, 
        0x04, 0x62, 
        0x04, 0x60,
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/prompt.json
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/expectedResults.json
        // tcId: 1
        0xAA, 0x9C, 0xC7, 0xDC, 0xA4, 0x91, 0xFC, 0x86, 0xBC, 0xB1, 
        0x5A, 0x70, 0x9A, 0x15, 0xE9, 0xB3, 0x90, 0x5C, 0x80, 0x0B, 
        0x6E, 0x2F, 0xB9, 0xB5, 0x4B, 0x6B, 0x05, 0x0E, 0xE5, 0xE4, 
        0xDE, 0x9A, 0xFA, 0x54, 0x64, 0xD1, 0xC6, 0x61, 0xFE, 0xD3, 
        0x8B, 0x2A, 0x51, 0xCA, 0x3E, 0xAE, 0x71, 0xBA, 0xCA, 0xE3, 
        0xD1, 0x86, 0x52, 0x15, 0xE3, 0xD3, 0x85, 0x0E, 0x8C, 0x1B, 
        0x82, 0x92, 0xBF, 0x42, 
        // Public key
        0xFA, 0x54, 0x64, 0xD1, 0xC6, 0x61, 0xFE, 0xD3, 0x8B, 0x2A, 
        0x51, 0xCA, 0x3E, 0xAE, 0x71, 0xBA, 0xCA, 0xE3, 0xD1, 0x86, 
        0x52, 0x15, 0xE3, 0xD3, 0x85, 0x0E, 0x8C, 0x1B, 0x82, 0x92,
        0xBF, 0x42
};
static const int sizeof_bench_sphincs_small_sha2_level1_key = sizeof(bench_sphincs_small_sha2_level1_key);
...
static const unsigned char bench_sphincs_small_sha2_level3_key[] =
{
        0x30, 0x81, 0xA3, 
        0x02, 0x01, 0x00, 
        0x30, 0x08, 0x06, 0x06, 0x2B, 0xCE, 0x0F, 0x06, 0x08, 0x0C, 
        0x04, 0x81, 
        0x93, 0x04,
        0x81, 0x90,
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/prompt.json
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/expectedResults.json
        // tcId: 41
        0x44, 0x2E, 0x44, 0x6E, 0x73, 0x33, 0x0A, 0xFB, 0x98, 0x70, 
        0x46, 0x56, 0x32, 0x8F, 0x4D, 0xD7, 0x33, 0x4F, 0x8A, 0x9A, 
        0xB4, 0xD9, 0x2C, 0xBE, 0x79, 0x0F, 0x91, 0xC2, 0xE9, 0x2A, 
        0x81, 0xAF, 0xEE, 0x0A, 0x7E, 0xC4, 0x5A, 0x3D, 0x60, 0x93, 
        0x46, 0x27, 0x6F, 0x5A, 0x32, 0x87, 0x55, 0xA1, 0x7D, 0xD4, 
        0x16, 0x08, 0xF5, 0x9E, 0x49, 0x26, 0x68, 0xD8, 0x1D, 0x03, 
        0x44, 0x13, 0x94, 0xFE, 0x7A, 0x8E, 0x7E, 0x58, 0x70, 0x5D, 
        0x76, 0x32, 0xBA, 0x8B, 0xC6, 0x6D, 0x04, 0xC9, 0x9E, 0xE5, 
        0xC7, 0x21, 0xE4, 0xFF, 0x4B, 0xBE, 0x78, 0x15, 0xCC, 0xF9, 
        0x23, 0xE8, 0x1E, 0x10, 0xC4, 0x75,
        // Public key
        0x7D, 0xD4, 0x16, 0x08, 0xF5, 0x9E, 0x49, 0x26, 0x68, 0xD8, 
        0x1D, 0x03, 0x44, 0x13, 0x94, 0xFE, 0x7A, 0x8E, 0x7E, 0x58, 
        0x70, 0x5D, 0x76, 0x32, 0xBA, 0x8B, 0xC6, 0x6D, 0x04, 0xC9, 
        0x9E, 0xE5, 0xC7, 0x21, 0xE4, 0xFF, 0x4B, 0xBE, 0x78, 0x15, 
        0xCC, 0xF9, 0x23, 0xE8, 0x1E, 0x10, 0xC4, 0x75
};
static const int sizeof_bench_sphincs_small_sha2_level3_key = sizeof(bench_sphincs_small_sha2_level3_key);
...
static const unsigned char bench_sphincs_small_sha2_level5_key[] =
{
        0x30, 0x81, 
        0xD3, 0x02, 0x01, 0x00, 
        0x30, 0x08, 0x06, 0x06, 0x2B, 0xCE, 0x0F, 0x06, 0x09, 0x0C, 
        0x04, 0x81, 
        0xC3, 0x04, 
        0x81, 0xC0, 
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/prompt.json
        // https://github.com/usnistgov/ACVP-Server/blob/master/gen-val/json-files/SLH-DSA-keyGen-FIPS205/expectedResults.json
        // tcId: 81
        , 
        // Public key
        0x13, 0x4D, 0x5E, 0xD3, 0xC6, 0x0B, 0x46, 0x34, 0x4A, 0x84, 
        0xA4, 0x5D, 0x46, 0x83, 0xB1, 0xAC, 0x55, 0xFB, 0x22, 0x88, 
        0x6B, 0xA9, 0x47, 0x8E, 0xA9, 0xCA, 0x93, 0xF2, 0x7B, 0x9A, 
        0xA2, 0xC2, 0x7C, 0x5C, 0x99, 0x08, 0xF0, 0x86, 0xE5, 0x79, 
        0x56, 0xF8, 0x5D, 0xE8, 0x4B, 0x43, 0x8E, 0xF1, 0xF0, 0x82, 
        0xCD, 0x17, 0x6D, 0xFF, 0x3C, 0x5B, 0x8B, 0xE7, 0x10, 0xBC, 
        0x86, 0x99, 0xA1, 0x43
};
static const int sizeof_bench_sphincs_small_sha2_level5_key = sizeof(bench_sphincs_small_sha2_level5_key);
